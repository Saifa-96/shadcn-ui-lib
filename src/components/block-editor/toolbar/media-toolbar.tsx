...
import { CaptionButton } from "../blocks/caption";
import {
  TablePopover as Popover,
  TablePopoverAnchor as PopoverAnchor,
  TablePopoverContent as PopoverContent,
} from "./table-popover";
...
/**
 * Floating toolbar that appears when a media element is selected.
 * Offers URL editing, caption toggle, and node removal.
 */
