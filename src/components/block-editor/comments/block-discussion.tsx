...
export const BlockDiscussion: RenderNodeWrapper<AnyPluginConfig> = (_props) => (props) => (
...
const BlockCommentContent = ({ children, element }: PlateElementProps) => {
  ...
  React.useLayoutEffect(() => {
    ...
    // toDOMNode only succeeds after the mark is committed to the DOM, so the
    // anchor is resolved in a layout effect (after DOM commit, before paint).
